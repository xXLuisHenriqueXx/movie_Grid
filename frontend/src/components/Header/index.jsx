...
const card = tv({
    slots: {
        containerHeader: 'relative w-full h-48 bg-header bg-cover bg-bottom bg-no-repeat',
        headerContent: 'w-full h-48 px-4 md:px-6 lg:px-8 flex flex-col justify-center items-center',
        title: 'mt-2 text-3xl md:text-4xl lg:text-5xl font-oswald font-bold text-slate-400 z-10',
