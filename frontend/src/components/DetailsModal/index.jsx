...
const card = tv({
  slots: {
    ...
    containerModal: 'absolute bottom-0 left-0 md:top-1/2 md:left-1/2 md:transform md:-translate-x-1/2 md:-translate-y-1/2 flex flex-col p-4 w-full md:w-[90%] h-3/4 overflow-auto bg-slate-700 rounded-t-3xl md:rounded-lg z-[99]',
    ...
    containerAgeRestriction: 'flex flex-row items-center p-2 bg-slate-800 rounded-md',
    iconClose: 'w-8 h-8 lg:w-10 lg:h-10 text-slate-900',
    imagePlaceholder: 'flex-shrink-0 w-full h-56 mx-auto mb-8 bg-slate-800 rounded-md',
    title: 'mb-2 text-3xl text-center font-oswald font-bold text-slate-950',
    ownerDirectorText: 'mb-2 text-lg text-center font-oswald font-semibold text-slate-900',
    descriptionText: 'text-lg text-center font-inter font-medium text-slate-900',
    createText: 'text-base font-inter font-medium text-slate-950',
