...
const card = tv({
  slots: {
    ...
    containerModal: 'absolute bottom-0 left-0 md:top-1/2 md:left-1/2 md:transform md:-translate-x-1/2 md:-translate-y-1/2 flex flex-col p-4 md:px-6 lg:px-8 w-full md:w-[90%] lg:w-2/3 xl:w-3/5 2xl:w-2/5 h-3/4 overflow-auto bg-slate-900 rounded-t-3xl md:rounded-lg z-[99]',
