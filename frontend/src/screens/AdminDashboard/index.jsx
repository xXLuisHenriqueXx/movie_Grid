    ...
    return (
        ...
        '>
            ...
            '>
                ...
                <DashboardTable type={"Programas de TV"} data={tvShows} setShowModal={setShowModalTvShow} showModal={showModalTvShow} />

                <Separator />

                <DashboardTable type={"Novelas"} data={soapOperas} setShowModal={setShowModalSoapOpera} showModal={showModalSoapOpera} />
                <Separator />

                <DashboardTable type={"Filmes"} data={movies} setShowModal={setShowModalMovie} showModal={showModalMovie} />
            </div>
        </div>
    )
}
